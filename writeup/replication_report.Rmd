...
The stimuli used in this replication project will follow the materials quoted above.
...
I plan to use the nls() function in R to perform nonlinear regression.
...
Additional data analysis steps from the paper:
"To match the scales for the two groups, we divided the estimates of the second group by a ratio of 13/9... The mean deviation from the true location of the missing vertex... and the standard deviation were calculated for each participant and then averaged across participants.
...
**Analysis**: The original paper performed regression using some function in Matlab (Mathematica 11.0), while I plan to use nls() in R. This should not affect the results.
